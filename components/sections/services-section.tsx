    ...
    return (
        <section className="py-32 bg-background text-foreground overflow-hidden">
            <div className="container mx-auto px-6 md:px-12 max-w-[1400px]">
                <div className="mb-24 flex flex-col md:flex-row items-end justify-between border-b border-black/10 pb-8">
                ...
                <div className="flex flex-col">
                    {services.map((service, idx) => (
                        <FadeIn key={service.id} delay={idx * 0.25}>
                            <Link
                                href={service.href}
                                className="group relative block border-t border-black/10 py-16 transition-all duration-500 hover:bg-[#F0F0F2]"
                            >
                                <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
                                    ...
                                    {/* Title */}
                                    <div className="md:w-[280px] lg:w-[360px] shrink-0 transition-transform duration-500 group-hover:translate-x-2">
